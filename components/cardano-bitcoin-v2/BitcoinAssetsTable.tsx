...
function AssetIcon({ src, symbol }: { src?: string; symbol: string }) {
  return (
    <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#1f3148] bg-[#030b18]">
      <Image
...
export function BitcoinAssetsTable({
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-[#1f3148] bg-[#07111f] shadow-[0_8px_30px_rgba(0,0,0,0.35)]">
      <div className="flex flex-col gap-4 border-b border-[#1f3148] p-6 md:flex-row md:items-center md:justify-between">
        <div>
        ...
        <a
          href="/methodology"
          className="rounded-lg border border-[#1f3148] bg-[#0b1728] px-4 py-2 text-sm font-medium text-slate-200 transition hover:border-orange-500/60 hover:text-orange-400"
        >
          View Methodology
        </a>
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[900px] text-left text-sm">
          <thead className="border-b border-[#1f3148] bg-[#030b18] text-slate-400">
            <tr>
          ...
          <tbody>
            {assets.map((asset) => (
              <tr
                key={asset.symbol}
                className="border-b border-[#1f3148] last:border-0 hover:bg-[#0b1728]/60"
              >
            ...
            <tr className="bg-[#21151a] font-semibold">
              <td className="px-6 py-4 text-orange-400">
                Total (All Assets)
              </td>

              <td className="px-6 py-4 text-white">All tracked assets</td>
              ...
              <td className="px-6 py-4 text-white">Mixed</td>
            </tr>
          </tbody>
        </table>
      </div>
